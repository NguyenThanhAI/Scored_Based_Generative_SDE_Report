...
\subsection{Một số ví dụ: VE, VP SDE và các SDE khác} \label{3.4}
...
bài toán tô màu (phụ lục \ref{I.3}) và chiến lực cho giải bài toán ngược tổng quát (phụ lục \ref{I.4}).
